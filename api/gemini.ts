    ...
    try {
        ...
        switch (type) {
            ...
            case 'findSolution': {
                ...
                const prompt = `You are an expert AI consultant for BANTConfirm, a B2B marketplace. A user needs help. Your task is to analyze their request and recommend the best service and vendors. USER'S REQUEST: "${query}". AVAILABLE SERVICES: ${serviceList}. AVAILABLE VENDORS: ${vendorList}. YOUR TASK: 1. Understand the user's core need. 2. Identify the single most relevant service. 3. Identify 2-3 vendors whose specialties align. 4. Write a brief summary explaining your recommendations. 5. Return the result in the specified JSON format.`;
