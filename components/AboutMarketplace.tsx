...
const CheckCircleIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-blue-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    return (
        <section className="bg-white py-12 md:py-16 px-6 md:px-12 rounded-xl shadow-lg border border-gray-200">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">About the BANTConfirm Marketplace</h2>
                    ...
                    <p className="text-gray-600 leading-relaxed mb-8">
                        We eliminate the guesswork and lengthy searches, providing a streamlined path to finding trusted partners who can deliver on your specific needs. Whether you're looking for a new CRM, cloud infrastructure, or a custom software solution, our platform ensures you get connected with qualified, competitive, and top-tier providers.
                    </p>
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4">
                        <FeatureListItem>AI-Powered BANT Qualification</FeatureListItem>
                        <FeatureListItem>Verified and Vetted Vendors</FeatureListItem>
                        <FeatureListItem>Earn Commission on Leads</FeatureListItem>
                        <FeatureListItem>Wide Range of IT Solutions</FeatureListItem>
                        <FeatureListItem>Streamlined Connection Process</FeatureListItem>
